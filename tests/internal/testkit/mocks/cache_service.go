...
func (m *CacheService) Put(key string, value interface{}, expiration time.Duration) error {
	args := m.Called(key, value, expiration)
	return args.Error(0)
}

func (m *CacheService) Add(key string, value interface{}, expiration time.Duration) (bool, error) {
	args := m.Called(key, value, expiration)
	return args.Bool(0), args.Error(1)
}

func (m *CacheService) Forever(key string, value interface{}) error {
	args := m.Called(key, value)
	return args.Error(0)
}

func (m *CacheService) Forget(key string) error {
	args := m.Called(key)
	return args.Error(0)
}

func (m *CacheService) Flush() error {
	args := m.Called()
	return args.Error(0)
}

func (m *CacheService) Has(key string) (bool, error) {
	args := m.Called(key)
	return args.Bool(0), args.Error(1)
}

func (m *CacheService) Pull(key string) (string, error) {
	args := m.Called(key)
	return args.String(0), args.Error(1)
}
...
func (m *CacheService) HealthCheck() error {
	args := m.Called()
	return args.Error(0)
}
