...
func createSingleFileCore(encoderConfig zapcore.EncoderConfig, level zapcore.Level, logConfig configs.LoggerConfig) (zapcore.Core, error) {
...
func createDailyFileCore(encoderConfig zapcore.EncoderConfig, level zapcore.Level, logConfig configs.LoggerConfig) (zapcore.Core, error) {
