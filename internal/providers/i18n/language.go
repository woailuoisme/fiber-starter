...
func resolveCookieLanguage(c fiber.Ctx, cfg configs.I18nConfig) string {
	if c == nil {
		return ""
	}
...
func resolveAcceptLanguage(c fiber.Ctx, cfg configs.I18nConfig) string {
	if c == nil {
		return ""
	}
...
func setLanguageCookie(c fiber.Ctx, cfg configs.I18nConfig, lang string) {
	if c == nil || lang == "" {
		return
	}
...
func cookieName(cfg configs.I18nConfig) string {
...
func GetLanguageCookie(c fiber.Ctx, cfg configs.I18nConfig) string {
	if c == nil {
		return ""
	}
...
func ClearLanguageCookie(c fiber.Ctx, cfg configs.I18nConfig) {
	if c == nil {
		return
	}
...
func SetLanguage(c fiber.Ctx, cfg configs.I18nConfig, lang string) error {
