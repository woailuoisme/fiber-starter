...
func ServiceUnavailableWithCause(message string, cause error) *AppError {
	return NewAppErrorWithCause(ErrCodeServiceUnavailable, message, http.StatusServiceUnavailable, cause)
}
...
func NewServiceUnavailableException(message string) *ServiceUnavailableException {
	...
	return &ServiceUnavailableException{
		APIException: newAPIException(message, 503),
	}
}
