...
func (r UpdateProfileRequest) ToInput() services.UpdateUserInput {
...
func (r UserListRequest) ToQuery() services.UserListQuery {
	r.Normalize()
	return services.UserListQuery{
		Page:  r.Page,
		Limit: r.Limit,
	}
}
...
func (r SearchUsersRequest) ToQuery() services.UserListQuery {
	r.Normalize()
	return services.UserListQuery{
		Search: r.Q,
		Page:   r.Page,
