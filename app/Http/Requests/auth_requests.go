...
func (r RegisterRequest) ToInput() services.RegisterInput {
...
func (r VerifySignUpRequest) ToInput() services.VerifyCodeInput {
	return services.VerifyCodeInput{
		Email: r.Email,
		Code:  r.Code,
	}
}
...
func (r LoginRequest) ToInput() services.LoginInput {
...
func (r ChangePasswordRequest) ToInput(userID int64) services.ChangePasswordInput {
	return services.ChangePasswordInput{
		UserID:          userID,
...
func (r ResetPasswordRequest) ToInput() services.PasswordResetRequestInput {
	return services.PasswordResetRequestInput{Email: r.Email}
}
...
func (r VerifyResetPasswordRequest) ToInput() services.VerifyCodeInput {
	return services.VerifyCodeInput{
		Email: r.Email,
		Code:  r.Code,
	}
...
func (r ConfirmResetPasswordRequest) ToInput() services.ConfirmPasswordResetInput {
	return services.ConfirmPasswordResetInput{
		Token:       r.Token,
