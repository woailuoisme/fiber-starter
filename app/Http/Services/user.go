...
type UserService interface {
	...
	UpdateUser(ctx context.Context, id int64, input UpdateUserInput) (*models.User, error)
	DeleteUser(ctx context.Context, id int64) error
	UpdateProfile(ctx context.Context, id int64, input UpdateUserInput) (*models.User, error)
...
func (s *userService) userRepo() (*repositories.UserRepository, error) {
	if s == nil || s.db == nil {
	...
	return repositories.NewUserRepository(bunDB), nil
}
...
func (s *userService) UpdateUser(ctx context.Context, id int64, input UpdateUserInput) (*models.User, error) {
	ctx = serviceContext(ctx)
	if input.IsZero() {
...
func (s *userService) UpdateProfile(ctx context.Context, id int64, input UpdateUserInput) (*models.User, error) {
...
func applyUserInput(user *models.User, input UpdateUserInput) {
	if input.Name != nil {
