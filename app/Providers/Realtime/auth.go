...
func BuildPresenceChannelData(user *models.User) string {
	if user == nil {
		return ""
	}
...
func BuildAuthResponse(cfg *configs.Config, socketID, channelName string, user *models.User) (AuthResponse, error) {
	if cfg == nil {
