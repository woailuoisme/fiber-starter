...
var userStatusMap = map[UserStatus]EnumInfo[UserStatus]{
	UserStatusActive:    {Value: UserStatusActive, Label: "活跃", Color: "success", Priority: 1},
	UserStatusInactive:  {Value: UserStatusInactive, Label: "非活跃", Color: "secondary", Priority: 2},
	UserStatusPending:   {Value: UserStatusPending, Label: "待审核", Color: "warning", Priority: 3},
	UserStatusSuspended: {Value: UserStatusSuspended, Label: "已暂停", Color: "warning", Priority: 4},
	UserStatusBanned:    {Value: UserStatusBanned, Label: "已封禁", Color: "danger", Priority: 5},
}

// 兼容旧版本值的映射表
var userStatusLegacyMap = map[string]UserStatus{
	"活跃":  UserStatusActive,
	"非活跃": UserStatusInactive,
	"待审核": UserStatusPending,
	"已暂停": UserStatusSuspended,
	"已封禁": UserStatusBanned,
}
