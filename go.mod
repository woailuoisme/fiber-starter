...
require (
	...
	github.com/gofiber/contrib/v3/circuitbreaker v1.1.2
	github.com/gofiber/contrib/v3/i18n v1.0.9
	github.com/gofiber/contrib/v3/jwt v1.2.0
	github.com/gofiber/contrib/v3/loadshed v1.1.7
	...
	github.com/gofiber/storage/ristretto/v2 v2.1.7
	github.com/gofiber/storage/rueidis v1.4.1
